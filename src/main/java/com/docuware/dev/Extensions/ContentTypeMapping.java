...
public class ContentTypeMapping {
    ...
    private static final HashMap<String, String> fileExtension2MediaType = new HashMap<String, String>();
    private static final HashMap<String, String> mediaType2FileExtension = new HashMap<String, String>();
