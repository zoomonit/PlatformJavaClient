...
public class ServiceConnection {
     ...
     * @return A future which is creating a proxy which handles further requests.
     */
    static private CompletableFuture<ServiceConnection> createAsyncNoConnection(final String serviceUri, final ServiceConnectionTransportData serviceConnectionTransportData) {


        return CompletableFuture.supplyAsync(new Supplier<ServiceConnection>() {
            @Override
    ...
    static public CompletableFuture<ServiceConnection> createWithWindowsAuthenticationAsync(final String serviceUri, final Credentials credentials, ServiceConnectionLoginData serviceConnectionLoginData) {
        final ServiceConnectionTransportData transport = serviceConnectionLoginData.getTransport();
        final MultivaluedMap<String, String> m = new MultivaluedMapImpl();
     ...
     * @return A future performing the action
     */
    public CompletableFuture<DeserializedHttpResponseGen<String>> postToCreatePermanentUrlForStringAsync(final MultivaluedMap data, Boolean clientSideChecksum, CancellationToken ct) {
        class Param {
        ...
        final URI uri = buildUri(parameters, "createPermanentUrl");

        CompletableFuture<DeserializedHttpResponseGen<String>> fut = CompletableFuture.<DeserializedHttpResponseGen<String>>supplyAsync(new Supplier<DeserializedHttpResponseGen<String>>() {
            @Override
            public DeserializedHttpResponseGen<String> get() {
                WebResource web = serviceDescription.getProxy().getHttpClient().resource(uri);
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Dialog>> getFromDialogForDialogAsync(String id, String fileCabinetId, DialogTypes[] dialogType, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Dialog>> fut = LinkResolver.<Dialog>getAsync(serviceDescription, uri, "application/xml", Dialog.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<BatchUpdateIndexFieldsResult>> postToBatchDialogUpdateFieldsForBatchUpdateIndexFieldsResultAsync(String fileCabinetId, String id, BatchUpdateProcess data, String[] fields, String[] sortOrder, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<BatchUpdateIndexFieldsResult>> fut = LinkResolver.<BatchUpdateIndexFieldsResult, BatchUpdateProcess>postAsync(serviceDescription, uri, "application/xml", "application/xml", BatchUpdateIndexFieldsResult.class, BatchUpdateProcess.class, "BatchUpdateProcess", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<String>> deleteFromDocumentDeleteForStringAsync(int id, String fileCabinetId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<String>> fut = LinkResolver.deleteAsync(serviceDescription, uri, "text/plain");
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Document>> getFromDocumentForDocumentAsync(int id, String fileCabinetId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Document>> fut = LinkResolver.<Document>getAsync(serviceDescription, uri, "application/xml", Document.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Document>> postToDocumentAppendFilesForDocumentAsync(int id, String fileCabinetId, MultiPart data, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Document>> fut = LinkResolver.<Document>postMultiPartAsync(serviceDescription, uri, "application/xml", Document.class, data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentsQueryResult>> getFromDocumentsForDocumentsQueryResultAsync(String fileCabinetId, String q, String[] fields, String[] sortOrder, Integer start, Integer msStart, Integer count, String format, Boolean includeSuggestions, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<DocumentsQueryResult>> fut = LinkResolver.<DocumentsQueryResult>getAsync(serviceDescription, uri, "application/xml", DocumentsQueryResult.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Document>> postToUploadDocumentForDocumentAsync(String fileCabinetId, Document data, Boolean processTextshot, Boolean imageProcessing, String redirect, String storeDialogId, Boolean checkFileNameForCheckinInfo, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Document>> fut = LinkResolver.<Document, Document>postAsync(serviceDescription, uri, "application/xml", "application/xml", Document.class, Document.class, "Document", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Document>> postToUploadDocumentForDocumentAsync(String fileCabinetId, InputStream data, Boolean processTextshot, Boolean imageProcessing, String redirect, String storeDialogId, Boolean checkFileNameForCheckinInfo, CancellationToken ct) {
        ...
        Param parameters = new Param(fileCabinetId, processTextshot, imageProcessing, redirect, storeDialogId, checkFileNameForCheckinInfo);
        URI uri = buildUri(parameters, "uploadDocument");
        CompletableFuture<DeserializedHttpResponseGen<Document>> fut = LinkResolver.<Document>postAsync(serviceDescription, uri, "*/*", "application/xml", Document.class, data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> getFromDocumentIndexFieldsForDocumentIndexFieldsAsync(int id, String fileCabinetId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> fut = LinkResolver.<DocumentIndexFields>getAsync(serviceDescription, uri, "application/xml", DocumentIndexFields.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> putToDocumentIndexFieldsForDocumentIndexFieldsAsync(int id, String fileCabinetId, DocumentIndexFields data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId);
        URI uri = buildUri(parameters, "documentIndexFields");
        CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> fut = LinkResolver.<DocumentIndexFields, DocumentIndexFields>putAsync(serviceDescription, uri, "application/xml", "application/xml", DocumentIndexFields.class, DocumentIndexFields.class, "DocumentIndexFields", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> putToDocumentIndexFieldsForDocumentIndexFieldsAsync(int id, String fileCabinetId, UpdateIndexFieldsInfo data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId);
        URI uri = buildUri(parameters, "documentIndexFields");
        CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> fut = LinkResolver.<DocumentIndexFields, UpdateIndexFieldsInfo>putAsync(serviceDescription, uri, "application/xml", "application/xml", DocumentIndexFields.class, UpdateIndexFieldsInfo.class, "UpdateIndexFieldsInfo", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> postToDocumentIndexFieldsForDocumentIndexFieldsAsync(int id, String fileCabinetId, DocumentIndexFields data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId);
        URI uri = buildUri(parameters, "documentIndexFields");
        CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> fut = LinkResolver.<DocumentIndexFields, DocumentIndexFields>postAsync(serviceDescription, uri, "application/xml", "application/xml", DocumentIndexFields.class, DocumentIndexFields.class, "DocumentIndexFields", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> postToDocumentIndexFieldsForDocumentIndexFieldsAsync(int id, String fileCabinetId, UpdateIndexFieldsInfo data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId);
        URI uri = buildUri(parameters, "documentIndexFields");
        CompletableFuture<DeserializedHttpResponseGen<DocumentIndexFields>> fut = LinkResolver.<DocumentIndexFields, UpdateIndexFieldsInfo>postAsync(serviceDescription, uri, "application/xml", "application/xml", DocumentIndexFields.class, UpdateIndexFieldsInfo.class, "UpdateIndexFieldsInfo", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<SuggestionFields>> getFromIntellixSuggestionsForSuggestionFieldsAsync(int id, String fileCabinetId, Boolean normalizeCoordinates, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<SuggestionFields>> fut = LinkResolver.<SuggestionFields>getAsync(serviceDescription, uri, "application/xml", SuggestionFields.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<InputStream>> getFromDocumentsFileDownloadForStreamAsync(int id, String fileCabinetId, FileDownloadType targetFileType, Boolean keepAnnotations, Boolean downloadFile, Boolean autoPrint, int[] layers, int[] append, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<InputStream>> fut = LinkResolver.<InputStream>getAsync(serviceDescription, uri, "*/*", InputStream.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Rights>> postToDocumentRightsForRightsAsync(int id, String fileCabinetId, Rights data, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Rights>> fut = LinkResolver.<Rights, Rights>postAsync(serviceDescription, uri, "application/xml", "application/xml", Rights.class, Rights.class, "Rights", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentLinks>> getFromDocumentDocumentLinksForDocumentLinksAsync(int id, String fileCabinetId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<DocumentLinks>> fut = LinkResolver.<DocumentLinks>getAsync(serviceDescription, uri, "application/xml", DocumentLinks.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<InputStream>> postToCheckoutForStreamAsync(int id, String fileCabinetId, CheckOutToFileSystemInfo data, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<InputStream>> fut = LinkResolver.<InputStream, CheckOutToFileSystemInfo>postAsync(serviceDescription, uri, "application/xml", "*/*", InputStream.class, CheckOutToFileSystemInfo.class, "CheckOutToFileSystemInfo", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<CheckOutResult>> postToCheckoutDocumentForCheckOutResultAsync(int id, String fileCabinetId, CheckOutToFileSystemInfo data, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<CheckOutResult>> fut = LinkResolver.<CheckOutResult, CheckOutToFileSystemInfo>postAsync(serviceDescription, uri, "application/xml", "application/xml", CheckOutResult.class, CheckOutToFileSystemInfo.class, "CheckOutToFileSystemInfo", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentAnnotations>> getFromDocumentAnnotationsForDocumentAnnotationsAsync(int id, String fileCabinetId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<DocumentAnnotations>> fut = LinkResolver.<DocumentAnnotations>getAsync(serviceDescription, uri, "application/xml", DocumentAnnotations.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<DocumentAnnotations>> postToDocumentAnnotationsForDocumentAnnotationsAsync(int id, String fileCabinetId, DocumentAnnotationsPlacement data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId);
        URI uri = buildUri(parameters, "documentAnnotations");
        CompletableFuture<DeserializedHttpResponseGen<DocumentAnnotations>> fut = LinkResolver.<DocumentAnnotations, DocumentAnnotationsPlacement>postAsync(serviceDescription, uri, "application/xml", "application/xml", DocumentAnnotations.class, DocumentAnnotationsPlacement.class, "DocumentAnnotationsPlacement", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<FileCabinet>> getFromFileCabinetForFileCabinetAsync(String fileCabinetId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<FileCabinet>> fut = LinkResolver.<FileCabinet>getAsync(serviceDescription, uri, "application/xml", FileCabinet.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Pages>> getFromPagesBlockForPagesAsync(String id, String fileCabinetId, Integer start, Integer count, Boolean embedThumbnailData, String thumbnailSize, Boolean thumbnailsOnly, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Pages>> fut = LinkResolver.<Pages>getAsync(serviceDescription, uri, "application/xml", Pages.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Annotation>> getFromAnnotationForAnnotationAsync(String id, String fileCabinetId, int page, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<Annotation>> fut = LinkResolver.<Annotation>getAsync(serviceDescription, uri, "application/xml", Annotation.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Annotation>> putToAnnotationForAnnotationAsync(String id, String fileCabinetId, int page, Annotation data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId, page);
        URI uri = buildUri(parameters, "annotation");
        CompletableFuture<DeserializedHttpResponseGen<Annotation>> fut = LinkResolver.<Annotation, Annotation>putAsync(serviceDescription, uri, "application/xml", "application/xml", Annotation.class, Annotation.class, "Annotation", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Annotation>> putToAnnotationForAnnotationAsync(String id, String fileCabinetId, int page, AnnotationsPlacement data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId, page);
        URI uri = buildUri(parameters, "annotation");
        CompletableFuture<DeserializedHttpResponseGen<Annotation>> fut = LinkResolver.<Annotation, AnnotationsPlacement>putAsync(serviceDescription, uri, "application/xml", "application/xml", Annotation.class, AnnotationsPlacement.class, "AnnotationsPlacement", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Annotation>> postToAnnotationForAnnotationAsync(String id, String fileCabinetId, int page, Annotation data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId, page);
        URI uri = buildUri(parameters, "annotation");
        CompletableFuture<DeserializedHttpResponseGen<Annotation>> fut = LinkResolver.<Annotation, Annotation>postAsync(serviceDescription, uri, "application/xml", "application/xml", Annotation.class, Annotation.class, "Annotation", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<Annotation>> postToAnnotationForAnnotationAsync(String id, String fileCabinetId, int page, AnnotationsPlacement data, CancellationToken ct) {
        ...
        Param parameters = new Param(id, fileCabinetId, page);
        URI uri = buildUri(parameters, "annotation");
        CompletableFuture<DeserializedHttpResponseGen<Annotation>> fut = LinkResolver.<Annotation, AnnotationsPlacement>postAsync(serviceDescription, uri, "application/xml", "application/xml", Annotation.class, AnnotationsPlacement.class, "AnnotationsPlaement", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    CompletableFuture<DeserializedHttpResponseGen<JAXBElement>> getFromClientSetupDataForXElementAsync(String orgId, String baseAddress, String clientSetupVersion, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<JAXBElement>> fut = LinkResolver.<JAXBElement>getAsync(serviceDescription, uri, "*/*", JAXBElement.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<String>> postToValidateUserForStringAsync(String id, UserValidation data, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<String>> fut = LinkResolver.<String, UserValidation>postAsync(serviceDescription, uri, "application/xml", "text/plain", String.class, UserValidation.class, "UserValidation", data);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    public CompletableFuture<DeserializedHttpResponseGen<SelectListInfo>> getFromSelectListForSelectListInfoAsync(String id, String selectListId, CancellationToken ct) {
        ...
        CompletableFuture<DeserializedHttpResponseGen<SelectListInfo>> fut = LinkResolver.<SelectListInfo>getAsync(serviceDescription, uri, "application/xml", SelectListInfo.class);
        if (ct != null) ct.addFuture(fut);
        return fut;
    }
    ...
    private URI buildUri(Object parameters, String template) {
        try {
            return new URI(
                    serviceDescription.getProxy().getBaseAddress().getScheme() + "://"
                            + serviceDescription.getProxy().getBaseAddress().getHost()
